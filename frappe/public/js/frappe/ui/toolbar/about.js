			...
			repl(
				`<div>
					...
					<p><i class='fa fa-graduation-cap fa-fw'></i>
						thinkNXG School: <a href='https://thinknxg.school' target='_blank'>https://thinknxg.school</a></p>
					<p><i class='fa fa-cloud fa-fw'></i>
						thinkNXG Cloud: <a href='https://thinknxg.cloud' target='_blank'>https://thinknxg.cloud</a></p>
					<hr>
